...
@section('current-page')
    Stock Dispense Awaiting Approval
@endsection
            ...
            <div class="col-xl-12 col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Stock Dispense Awaiting Approval</h4>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="{{route("view-dispense-to-mlo-item", $item->ref_code)}}" > <i class="bx bx-book-open text-warning"></i> View</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
