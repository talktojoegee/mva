            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form autocomplete="off" autcomplete="off" action="{{route('add-mlo-setup')}}" method="post" id="addBranch" data-parsley-validate="">
                        ...
                        <div class="form-group mt-3">
                            <label for=""> Last Name <span class="text-danger">*</span></label>
                            <input type="text" name="lastName" required placeholder="Last Name" data-parsley-required-message="Enter Last Name" class="form-control">
                            @error('lastName') <i class="text-danger">{{$message}}</i>@enderror
                        </div>
                        <div class="form-group mt-3">
                            <label for=""> First Name <span class="text-danger">*</span></label>
                            <input type="text" name="firstName" required placeholder="First Name" data-parsley-required-message="First Name" class="form-control">
                            @error('firstName') <i class="text-danger">{{$message}}</i>@enderror
                        </div>
                        <div class="form-group mt-3">
                            <label for=""> Other Names <small>(Optional)</small></label>
                            <input type="text" name="otherNames" placeholder="Other Names" data-parsley-required-message="Enter Other Names" class="form-control">
                            @error('otherNames') <i class="text-danger">{{$message}}</i>@enderror
                        </div>
                        <div class="form-group mt-3">
                            <label for=""> Phone Number <span class="text-danger">*</span></label>
                            <input type="text" name="phoneNo" required placeholder="Phone Number" data-parsley-required-message="Enter Phone Number" class="form-control">
                            @error('phoneNo') <i class="text-danger">{{$message}}</i>@enderror
                        </div>
                        <div class="form-group mt-3">
                            <label for=""> Email Address <span class="text-danger">*</span></label>
                            <input type="email" name="email" required placeholder="Email Address" data-parsley-required-message="Enter Email Address" class="form-control">
                            @error('email') <i class="text-danger">{{$message}}</i>@enderror
                        </div>
                        <div class="form-group d-flex justify-content-center mt-3">
                            <div class="btn-group">
